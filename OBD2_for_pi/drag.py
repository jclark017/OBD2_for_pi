...
class Speedometer(Layer):
    ...
    def draw(self):
        ellipse(0, 0, self.width, self.height, fill=self.clr, stroke=self.clr)
        ellipse(0,0,5,5)
...
r1 = Speedometer(x=300, y=200, width=200, height=200, origin=(0.5,0.5), name="blue1")
