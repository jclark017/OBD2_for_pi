...
def rpm(code):
    codea = hex_to_int(code[:2])
    codeb = hex_to_int(code[2:])
    return ((codea*256)+codeb)/4
...
SENSORS = [
    ...
    Sensor("     Coolant Temperature", "0105", temp              ,"F"      ),
